...
const handleRemoveItem = (id, setAppointmentList, appointmentList) => {
  ...
  return (
    <div className='App container mx-auto mt-3 font-thin'>
      ...
      <Search
        ...
        orderBy={orderBy}
        onOrderByChange={order => setOderBy(order)}
        sortBy={sortBy}
      ...
      <ul className='divide-y divide-gray-200'>
        {filteredAppointments.map(appointment => (
          <AppointmentInfo
            ...
            onDeleteAppointment={appointmentId => handleRemoveItem(appointmentId, setAppointmentList, appointmentList)} />
        ))}
      </ul>
    </div>
  );
